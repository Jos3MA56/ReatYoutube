...
export default function YouTubeHome() {
    ...
    return (
        <ScrollView style={estilos.container}>
            ...
            <FlatList
                data={videos}
                numColumns={1} // Fijamos el número de columnas a 1
...
const estilos = StyleSheet.create({
    ...
    thumbnail: {
        ...
        aspectRatio: 16 / 9, // Relación de aspecto estándar para videos
        borderRadius: 5,
    },
    videoInfo: {
    ...
    activeNavText: {
        color: '#FF0000', // Rojo para indicar la pestaña activa
    },
});